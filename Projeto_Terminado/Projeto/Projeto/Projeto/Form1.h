...
#include "Power.h"
#include <cmath>
double res_tot, resistencia, reatancia1, reatancia2, corrente_tot, V1, V2, I1, I2, I3, corrente_diac;
int test = 0;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->ClientSize = System::Drawing::Size(887, 392);
...
#pragma endregion
	...
	private: System::Void button5_Click(System::Object^  sender, System::EventArgs^  e) {
				MessageBox::Show("Tensao do DIAC: 28-36V\nCorrente maxima do DIAC: 100mA\n");
			 }
...
private: System::Void simular_Click(System::Object^  sender, System::EventArgs^  e) {
			 if ( Cap1 && Cap2 && Res && Pot && Tensao && Freq ) {
				 ...
				 V2 = I2*Res;
				 corrente_diac = I2;
				 label8->Text = Convert::ToString(V2) + "V";
				 label10->Text = Convert::ToString(corrente_diac)+"A";
				 if ( corrente_diac <= 0,1 && V2 <= 38 && V2 >= 28 ) {
					 test = 1;
